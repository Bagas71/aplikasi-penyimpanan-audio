                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="nama" required class="form-control" id="nama" placeholder="Masukkan Nama Perekam...">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="rekaman" required class="form-control" id="rekaman" placeholder="Masukkan Nama Rekaman...">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="jenis" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Jenis Rekaman</label>
                                 <div class="col-lg-10">
                                    <select id="jenis" class="form-control m-bot15" name="jenis"  required value="">
                                    <option> PRO1 </option>
                                    <option> PRO2 </option>
                                    <option> PRO3 </option> 
                                    <option> PRO4 </option>  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea type="text" name="keterangan" required class="form-control" id="keterangan" placeholder="Masukkan Keterangan Baru..."></textarea>
                                </div>
                            </div>
